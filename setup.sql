...
CREATE WAREHOUSE IF NOT EXISTS NETWORK_OPS_WH
    ...
    COMMENT = '{"origin":"sf_sit-is","name":"network_ops_wh","virsion":{"major":1,"minor":0},"attributes":{"is_quickstart":1, "component":"warehouse","demo":"telecom_network_operations", "industry":"telecommunications"}}';


CREATE WHAREHOUSE IF NOT EXISTS NETWORK_OPS_BUILD_WH
    WITH WAREHOUSE_SIZE = 'MEDIUM'
    AUTO_SUSPEND = 60
    AUTO_RESUME = TRUE
    INITIALLY_SUSPENDED = TRUE
    COMMENT = '{"origin":"sf_sit-is","name":"network_ops_build_wh","virsion":{"major":1,"minor":0},"attributes":{"is_quickstart":1, "component":"warehouse","demo":"telecom_network_operations", "industry":"telecommunications"}}';

-- ===========================================================================================
-- SECTION 2: ROLE SETUP
-- ===========================================================================================
CREATE ROLE IF NOT EXISTS NETWORK_OPS_ANALYST
COMMENT = 'Role for Network Operation Analytics users';
...
-- ===========================================================================================
-- SECTION 3: DATABASE AND SCHEMA SETUP 
-- ===========================================================================================
...
-- Create shemas for different network domains
...
-- Grant ownership to analyst role after all objects are created
GRANT OWNERSHIP ON DATABASE NETWORK_OPERATIONS TO ROLE NETWORK_OPS_ANALYST copy CURRENT GRANTS;

-- ===========================================================================================
-- SECTION 4: GITHUB EXTERNAL ACCESS INTEGRATION SETUP
-- ===========================================================================================  
USE SCHEMA STAGING;
